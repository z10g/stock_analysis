...
```mermaid
xychart-beta
  title "MCO 分红与回购（USD bn，近似）"
  x-axis [2021, 2022, 2023, 2024, 2025]
  y-axis "USD bn" 0 --> 2.5
  bar [0.54, 0.61, 0.69, 0.80, 0.91]
  bar [1.80, 2.05, 1.38, 1.30, 1.30]
```
...
```mermaid
xychart-beta
  title "MCO 营收与营业利润（USD bn，近似）"
  x-axis [2021, 2022, 2023, 2024, 2025]
  y-axis "USD bn" 0 --> 9
  bar [6.22, 5.47, 5.92, 6.68, 8.03]
  line [2.55, 2.15, 2.49, 2.88, 3.35]
```
